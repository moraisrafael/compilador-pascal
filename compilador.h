...
typedef enum simbolos {
  ...
  simb_ident, simb_numero, simb_label, simb_goto, simb_read, simb_write,
  simb_maior, simb_menor,  simb_maior_igual, simb_menor_igual, simb_then,
  simb_imag, simb_imaginario
} simbolos;
